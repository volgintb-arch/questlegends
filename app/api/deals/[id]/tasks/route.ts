...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const [task] = await sql`
      INSERT INTO "DealTask" (id, "dealId", title, description, "assigneeId", deadline, status, "isCompleted", "createdAt")
      VALUES (${taskId}, ${dealId}, ${title}, ${description || null}, ${assigneeId || null}, ${deadlineValue}, 'pending', false, ${now})
      RETURNING *
    `
