  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h1 className="text-xl font-bold">Интеграции с соцсетями для УК</h1>
          <p className="text-xs text-muted-foreground">Настройка получения лидов в CRM систему управляющей компании</p>
        </div>
